...
namespace HSVIEWER.Controllers
{
    public class DealsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DealId,Amount,Name,HsStageId,HsOwnerId,hsdate")] Deal deal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DealId,Amount,Name,HsStageId,HsOwnerId,hsdate")] Deal deal)
        {
            if (id != deal.DealId)
            {
                return NotFound();
